...
function fmtWait(t: number): string {
  if (t < 1) return '<1s'
  ...
  return (
    <div className="panel exhibit-panel">
      ...
      <div className="scroll-area">
        <div style={{ fontSize: 11, color: '#a0a0c0', marginBottom: 6 }}>
          按人气排序 · ★ 镇馆之宝
        </div>
            ...
            return (
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 10, color: '#8090b0', marginTop: 2 }}>
                    平均等待 {fmtWait(e.avgQueueTime)}
                  </div>
                </div>
